...
- COLLECTFERTILIZER — Collect 1 fertilizer from the animal. Every surviving animal makes 1 available at the end of each day, whether or not it was fed or cared for. Uncollected fertilizer does not accumulate, so an animal left alone for five days still yields 1 unit.
...
- BUILDCOOP  adds a coop to an unoccupied tile  
- BUILDPASTURE  add pasture to an unoccupied tile  
...
- BUYSEED — Purchase N units of a single item from the market.  
  - BUYSEED WHEAT 1
- BUYANIMAL    
  - BUYANIMAL GOOSE 1
- BUYPRODUCT  
  - BUYPRODUCT WHEAT 1  
  - BUYPRODUCT FERTILIZER 1
...
- BUYLAND  unlock a new 5x5 segment of land to plant on. Increasing in cost.   
  - Costs are: $1k, $2k, $4k
...
| shedCapacity           | 100what | Max non-seed items the shed can hold; overflow at end-of-day drop is discarded                                                 |
